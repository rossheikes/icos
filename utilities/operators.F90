...
!  BEGIN curl_crn
!=======================================================================
   SUBROUTINE curl_crn (wrap_name,km0,km1,x1,x2)
!-----------------------------------------------------------------------
!
!.......................................................................
!  INTENT IN
...
!.:. .:. .:. .:. .:. .:. .:. .:. .:. .:. .:. .:. .:. .:. .:. .:. .:. .:.
   ...
   DO nsd = 1,nsdm
      DO k = km0,km1
         DO j = 2,jm-1
            DO i = 2,im-1
               x2(1,i,j,k,nsd) = &!(one/area_crn(1,i,j,nsd))* &
                              (x1(1,i  ,j  ,k,nsd)*d_point(1,i  ,j  ,nsd) + &
                               x1(3,i+1,j  ,k,nsd)*d_point(3,i+1,j  ,nsd) - &
                               x1(2,i  ,j  ,k,nsd)*d_point(2,i  ,j  ,nsd))
               x2(2,i,j,k,nsd) = &!(one/area_crn(2,i,j,nsd))* &
                              (x1(2,i  ,j  ,k,nsd)*d_point(2,i  ,j  ,nsd) - &
                               x1(1,i  ,j+1,k,nsd)*d_point(1,i  ,j+1,nsd) - &
                               x1(3,i  ,j  ,k,nsd)*d_point(3,i  ,j  ,nsd)) 
            ENDDO
         ENDDO
      ENDDO
   ENDDO

   CALL wrap (wrap_name,vrtx_scalar=x2)

   END SUBROUTINE curl_crn
!=======================================================================
!  END curl_crn
!=======================================================================

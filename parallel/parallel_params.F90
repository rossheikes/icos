...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   INTEGER (KIND=int_kind),PARAMETER :: &
      npe_wrld = 00000640 ! number of process elements within the
                          ! world communicator

   INTEGER (KIND=int_kind) :: &
      npe_io   = 02, &  ! number of process elements within an io group
      rnk_wrld = 00     ! an identifier for the local process within the
                        ! world communicator
